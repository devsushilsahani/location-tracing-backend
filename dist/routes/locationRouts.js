...
router.post('/locations', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/routes', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const route = yield prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            // Create the route
            const newRoute = yield tx.route.create({
                data: {
                    date: new Date(date),
...
router.delete('/locations', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield prisma.location.deleteMany({
            where: {
                timestamp: {
                    lt: date,
                },
